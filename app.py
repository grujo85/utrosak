...
# ==========================================
# 3. PDF GENERACIJA (SA CACHE ZASTITOM)
# ==========================================
@st.cache_data(show_spinner=False)
def generate_pdf_bytes(df_json):
    # Konvertujemo nazad iz JSON-a (sigurnije za cache)
...
if not df.empty:
    ...
    # Koristimo key da bi editor bio stabilan
    edited_df = st.data_editor(df, use_container_width=True, hide_index=True, num_rows="dynamic", key="urednik_podataka")
    ...
    # GENERISANJE PDF-a samo ako korisnik klikne ili ako je potrebno
    # DF konvertujemo u JSON jer st.cache_data voli proste objekte
    pdf_izlaz = generate_pdf_bytes(edited_df.to_json())
